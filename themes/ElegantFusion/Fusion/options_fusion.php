...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Main Background Image",$themename),
				   "id" => $shortname."_bg_image",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Here you can upload the main background image, used for the header and footer areas.",$themename)
			),
			...
			array( "name" => esc_html__("Show Twitter Icon",$themename),
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display your Twitter Icon. ",$themename)
			),
			...
			array( "name" => esc_html__("Show RSS Icon",$themename),
                   ...
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display your RSS Icon. ",$themename)
			),
			...
			array( "name" => esc_html__("Show Facebook Icon",$themename),
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display your Facebook Icon. ",$themename)
			),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Display Testimonials",$themename),
                   "id" => $shortname."_show_testimonials",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Testimonials on the homepage. ",$themename)
			),

			array( "type" => "clearfix",),

			array( "name" => esc_html__("Display Recent News",$themename),
                   "id" => $shortname."_show_recent_news",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Recent News section on the homepage. ",$themename)
			),

			array( "name" => esc_html__("Display Clients Logos",$themename),
                   "id" => $shortname."_show_logos",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display Clients logos section on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Recent News more link URL",$themename),
                   "id" => $shortname."_more_news_link",
                   "std" => '',
                   "type" => "text",
				   "desc" => esc_html__("Place the Recent News more link URL here. ",$themename),
				   "validation_type" => "url"
			),

			array( "name" => esc_html__("Number of posts in the Testimonials slider",$themename),
                   "id" => $shortname."_home_testimonials_number",
                   "std" => '3',
                   "type" => "text",
				   "desc" => esc_html__("Here you can choose the number of testimonials on the homepage. ",$themename),
				   "validation_type" => "number"
			),
			...
			array( "name" => esc_html__("1st Logo Image",$themename),
				   "id" => $shortname."_logo_path_1",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Here you can upload the client logo image.",$themename)
			),

			array( "name" => esc_html__("1st Logo Url",$themename),
                   "id" => $shortname."_logo_url_1",
                   "std" => '',
                   "type" => "text",
			...
			array( "name" => esc_html__("1st Logo Alt",$themename),
                   "id" => $shortname."_logo_alt_1",
                   "std" => '',
                   "type" => "text",
			...
			array( "name" => esc_html__("2nd Logo Image",$themename),
				   "id" => $shortname."_logo_path_2",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Here you can upload the client logo image.",$themename)
			),

			array( "name" => esc_html__("2nd Logo Url",$themename),
                   "id" => $shortname."_logo_url_2",
                   "std" => '',
                   "type" => "text",
				   "desc" => esc_html__("Place the client logo url here. ",$themename),
				   "validation_type" => "url"
			...
			array( "name" => esc_html__("2nd Logo Alt",$themename),
                   "id" => $shortname."_logo_alt_2",
                   "std" => '',
                   "type" => "text",
				   "desc" => esc_html__("Place the client logo description here. ",$themename),
				   "validation_type" => "nohtml"
			...
			array( "name" => esc_html__("3rd Logo Image",$themename),
				   "id" => $shortname."_logo_path_3",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Here you can upload the client logo image.",$themename)
			),

			array( "name" => esc_html__("3rd Logo Url",$themename),
                   "id" => $shortname."_logo_url_3",
                   "std" => '',
                   "type" => "text",
				   "desc" => esc_html__("Place the client logo url here. ",$themename),
				   "validation_type" => "url"
			...
			array( "name" => esc_html__("3rd Logo Alt",$themename),
                   "id" => $shortname."_logo_alt_3",
                   "std" => '',
                   "type" => "text",
				   "desc" => esc_html__("Place the client logo description here. ",$themename),
				   "validation_type" => "nohtml"
			...
			array( "name" => esc_html__("4th Logo Image",$themename),
				   "id" => $shortname."_logo_path_4",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Here you can upload the client logo image.",$themename)
			),

			array( "name" => esc_html__("4th Logo Url",$themename),
                   "id" => $shortname."_logo_url_4",
                   "std" => '',
                   "type" => "text",
				   "desc" => esc_html__("Place the client logo url here. ",$themename),
				   "validation_type" => "url"
			...
			array( "name" => esc_html__("4th Logo Alt",$themename),
                   "id" => $shortname."_logo_alt_4",
                   "std" => '',
                   "type" => "text",
				   "desc" => esc_html__("Place the client logo description here. ",$themename),
				   "validation_type" => "nohtml"
