    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/twocoda.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/twocoda.min.css': 'assets/css/twocoda.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/twocoda.min.css'] }
            }
        }
    });
