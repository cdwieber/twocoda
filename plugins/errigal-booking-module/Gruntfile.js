    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/errigal-booking-module.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/errigal-booking-module.min.css': 'assets/css/errigal-booking-module.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/errigal-booking-module.min.css'] }
            }
        }
    });
