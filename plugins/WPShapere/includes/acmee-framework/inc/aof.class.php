    ...
    <?php
        ...
        function licenseUpdated() {
            if(isset($_GET['status']) && $_GET['status'] == 'license_success') {
                ...
                echo ' <a class="wps-kb" target="_blank" href="https://kb.acmeedesign.com/kbase_categories/wpshapere/">';
        ...
        function saveBtn() {
          ?>
            <div class="save_options">
              <input type="submit" value="<?php _e('Save Changes', 'wps'); ?>" class="aof_save_button" />
            </div>
          <?php
        }
        ...
        function addIcon($fields) {
            ...
            $form_field = '<div class="menu_icon">
                <label for="icon_picker"><em>'. __('Choose Icon', 'wps') . '</em></label>
