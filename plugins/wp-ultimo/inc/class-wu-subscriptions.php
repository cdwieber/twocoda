...
class WU_Subscriptions {
  ...
  public function callback_transaction_process_delete() {
    ...
    if (!isset($_POST['transaction_id'])) {
      ...
      wp_send_json_error(__('Something error', 'wp-ultimo') . ': transaction_id undefined');
    ...
    if (!$deleted) {
      ...
      wp_send_json_error(__('Something error', 'wp-ultimo'));
  ...
  public function handle_remove_account() {
    ...
    if (isset($_POST['wu_action']) && $_POST['wu_action'] == 'wu_remove_account') {
      ...
      return wp_die(__('Your account, site and subscription was successfully deleted.', 'wp-ultimo'), __('Account successfully removed', 'wp-ultimo'));
