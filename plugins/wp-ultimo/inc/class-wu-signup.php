...
class WU_Signup {
  ...
  public function get_register_url($register_url) {
    ...
    $registration_url = WU_Settings::get_setting('registration_url', false);
  ...
  public function check_auto_select_plan($wp_query) {
    ...
    if ($parsed_request['path'] == WU_Settings::get_setting('registration_url', false)) {
      ...
      if (!isset($duplicated['site_id'])) {
        ...
        return new WP_Error('duplication_error', $message);
			...
			if (!is_super_admin($user_id)) {
				...
				$removed_from_template = remove_user_from_blog($user_id, $template_id);
