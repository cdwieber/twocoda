...
class WU_Settings {
   ...
   */
  public static function get_logo($size = 'full', $logo = false, $setting_name = 'logo') {
  ...
  public static function get_sections($filters = true) {
    ...
    $gateway_fields = array(
      ...
      'payment_integration_desc' => array(
        ...
        'placeholder'   => __('We now need to complete your payment settings, setting up a payment subscription. Use the buttons below to add a integration.', 'wp-ultimo'),
        'type'          => 'textarea',
        'desc'          => '',
        'tooltip'       => '',
        'default'       => '',
      ...
      'network' => array(
        ...
        'fields' => apply_filters('wu_settings_section_network', array(
          ...
          'registration_url' => array(
            ...
            'desc'          => __('Select a custom URL to replace the default wp-signup.php. Leave blank to continue to use wp-signup.php. <br>Requires pretty permalinks enabled on the main site.', 'wp-ultimo'),
          ...
          'login_url' => array(
            ...
            'desc'          => __('Select a custom URL to replace the default wp-login.php. Leave blank to continue to use wp-login.php. <br>Requires pretty permalinks enabled on the main site.', 'wp-ultimo'),
            'tooltip'       => __('Pretty permalinks must be enabled on your main network\'s site for this to work.', 'wp-ultimo'),
            'type'          => 'text',
            'default'       => '',
      ...
      'domain_mapping' => array(
        ...
        'fields' => apply_filters('wu_settings_section_domain_mapping', array(
          ...
          'allow_page_unmapping'  => array(
            ...
            'desc'          => __('Adds a metabox to your clients\' post type edit pages, giving them the option to unmap particular pages and posts. Usefull for checkout pages and other instances were your client might use your network\'s SSL certificate.', 'wp-ultimo'),
            'tooltip'       => __('', 'wp-ultimo'),
            'type'          => 'checkbox',
            'default'       => true,
            'require'       => array('enable_domain_mapping' => 1),
      ...
      'advanced' => array(
        ...
        'fields' => apply_filters('wu_settings_section_advanced', array(
         ...
         'remove_transients' => array(
            ...
            'desc'          => __('Transients are temporary entries on the database. We use them to store the signup information of your users why they are navigating the multi-step signup flow. We only keep them on the databse for a limited amount of time (40 minutes by default), but you can use this to clean them up if you need to.', 'wp-ultimo'),
