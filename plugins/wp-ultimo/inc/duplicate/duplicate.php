...
if( !class_exists( 'MUCD_Duplicate' ) ) {
    ...
    require_once WP_Ultimo()->path('inc/duplicate/constants.php');
    require_once WP_Ultimo()->path('inc/duplicate/functions.php');
    require_once WP_Ultimo()->path('inc/duplicate/option.php');
    require_once WP_Ultimo()->path('inc/duplicate/files.php');
    require_once WP_Ultimo()->path('inc/duplicate/data.php');
    require_once WP_Ultimo()->path('inc/duplicate/log.php');
    ...
    class MUCD_Duplicate {
        ...
        public static function duplicate_site($data) {
            ...
            $result = MUCD_Data::copy_data($from_site_id, $to_site_id, $copy_file == 'yes');
            ...
            $form_message['msg'] = WU_NETWORK_PAGE_DUPLICATE_NOTICE_CREATED;
        ...
        /**
         * Copy site's content to a new site. Used for template switching
         *
         * @since 1.6.0
         ...
         * @return void
         */
        public static function switch_template($from_site_id, $to_site_id, $data) {
        ...
        public static function create_admin($email, $domain) {
            ...
            if ( !$user_id ) { // Create a new user with a random password
                ...
                if ( false == $user_id ) {
                    return new WP_Error( 'file_copy', WU_NETWORK_PAGE_DUPLICATE_ADMIN_ERROR_CREATE_USER);
                }
                else {
