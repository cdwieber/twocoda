...
class WU_Domain_Mapping_Hosting_Support {
  ...
  public function get_runcloud_base_url($path = '') {
    ...
    return "https://manage.runcloud.io/base-api/servers/$serverid/webapps/$appid/domainname/$path";
  ...
  public function add_domain_to_runcloud($mapping) {
    ...
    foreach($domain_list as $domain) {
      ...
      $response = $this->send_runcloud_request($this->get_runcloud_base_url(), array(
        'domainName' => $domain
      ), 'POST');
  ...
  public function get_runcloud_domain_id($domain) {
    ...
    $domains_list = $this->send_runcloud_request($this->get_runcloud_base_url(), array(), 'GET');
  ...
  public function remove_domain_from_runcloud($mapping) {
    ...
    foreach ($domain_list as $domain) {
      ...
      $response = $this->send_runcloud_request($this->get_runcloud_base_url($domain_id), array(), 'DELETE');
