  ...
  <div id="wu_general" class="panel wu_options_panel">
    ...
    <div class="options_group">
      <p class="form-field expiring_date_field">
        ...
        <input type="text" style="padding: 5px;" data-format="Y-m-d H:i:S" class="short wu-datepicker" data-allow-time="true" style="" name="expiring_date" id="expiring_date" value="<?php echo $coupon->expiring_date ? $coupon->expiring_date : '' ?>" placeholder="<?php _e('Click to edit', 'wp-ultimo'); ?>">
