...
if (!class_exists('WU_Addon_Updater_Free')) :

/**
 * WU_Addon_Updater_Free
 */
class WU_Addon_Updater_Free {
  ...
  public function enable_update_checker() {
    ...
    $updateChecker = PucFactory::buildUpdateChecker(
      $this->get_update_URL(),  // Metadata URL.
...
} // end class WU_Addon_Updater_Free;
